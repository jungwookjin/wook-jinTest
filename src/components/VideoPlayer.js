...
export default class VideoPlayer extends Component {
    ...
    renderTopControls() {
        ...
        return (
            <Animated.View
                ...
                <ImageBackground
                    source={require('../img/icons/top-vignette.png')}
            ...
            <View style={VideoPlayerstyles.volume.container}>
                ...
                <View
                    ...
                    <Image
                        ...
                        source={require('../img/icons/volume.png')}
                    />
                </View>
            </View>
        );
    ...
    renderFullscreen() {
        let source =
            this.state.isFullscreen === true
                ? require('../img/icons/shrink.png')
                : require('../img/icons/expand.png');
        return this.renderControl(
            <Image source={source} />,
            this.methods.toggleFullscreen,
    ...
    renderBottomControls() {
        ...
        return (
            <Animated.View
                ...
                <ImageBackground
                    source={require('../img/icons/bottom-vignette.png')}
                    style={[VideoPlayerstyles.controls.column]}
                    imageStyle={[VideoPlayerstyles.controls.vignette]}>
                    {seekbarControl}
                    <SafeAreaView
    ...
    renderPlayPause() {
        let source =
            this.state.paused === true
                ? require('../img/icons/play.png')
                : require('../img/icons/pause.png');
        return this.renderControl(
            <Image source={source} />,
            this.methods.togglePlayPause,
    ...
    renderTimer() {
        return this.renderControl(
            <Text allowFontScaling={false} style={VideoPlayerstyles.controls.timerText}>{this.calculateTime()}</Text>,
        ...
        if (this.state.loading) {
            return (
                <View style={VideoPlayerstyles.loader.container}>
                    <Animated.Image
                        source={require('../img/icons/loader-icon.png')}
                        style={[
                ...
                <SafeAreaView style={VideoPlayerstyles.error.container}>
                    <TouchableOpacity onPress={() => this.reloadPlayer()}>
                        <View style={{ justifyContent: 'center', alignItems: 'center', }}>
                            <Image
                                source={require('../img/icons/error-icon.png')}
                                style={VideoPlayerstyles.error.icon}
                            />
                            <Text allowFontScaling={false} style={VideoPlayerstyles.error.text}>파일을 찾을 수 없어요</Text>
                            <Text allowFontScaling={false} style={VideoPlayerstyles.error.text}>(다시 불러오기)</Text>
                        </View>
                    </TouchableOpacity>
                </SafeAreaView>
            );
                            ...
                            <View style={{
                                ...
                                <View style={{
                                    ...
                                    <TouchableOpacity onPress={() => this.playVideo()}>
                                        <Image
                                            source={require('../img/ic_video_play.png')}
                                            style={VideoPlayerstyles.error.icon}
                                        /></TouchableOpacity>
                                </View>
                            </View>
